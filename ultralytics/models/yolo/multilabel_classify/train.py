...
class MultilabelClassificationTrainer(BaseTrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        if overrides is None:
            overrides = {}
        overrides['task'] = 'multilabel_classify'
    ...
    def build_dataset(self, img_path, mode='train', batch=None):
        return MultilabelClassificationDataset(root=img_path, args=self.args, augment=mode == 'train', prefix=mode)
    ...
    def get_validator(self):
        """Returns an instance of MultilabelClassificationValidator for validation."""
        self.loss_names = ['loss']
        return yolo.multilabel_classify.MultilabelClassificationValidator(self.test_loader, self.save_dir)
